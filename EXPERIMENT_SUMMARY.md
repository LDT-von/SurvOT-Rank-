...
### 分箱 B 全部 5-fold 排名（按 last5）

| # | 方法 | seed | avg_best | avg_last5 | best→last5 gap |
|---|------|:---:|:---:|:---:|:---:|
| 1 | **v50_norank** | 22646 | 0.7148 ± 0.025 | **0.6572 ± 0.011** | -0.058 |
| 2 | v45_norank | None | 0.6848 ± 0.037 | 0.6406 ± 0.025 | -0.044 |
| 3 | v45v2_norank | 323 | 0.7063 ± 0.029 | 0.6394 ± 0.025 | -0.067 |
| 4 | V51 seed3 | 3 | 0.6786 ± 0.055 | 0.6207 ± 0.058 | -0.058 |
| 5 | V51 seed5 | 5 | 0.6583 ± 0.058 | 0.6088 ± 0.047 | -0.050 |
| 6 | V60 | 3 | 0.6791 ± 0.048 | 0.6063 ± 0.031 | -0.073 |

⚠️ 所有排名基于随机 seed（非固定 3/5/1），仅属于探索性。正式结论需固定 seed 复核。
