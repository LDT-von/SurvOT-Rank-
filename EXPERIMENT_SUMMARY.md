...
## newSlotSPE / SlotSPE 全部方法 (5-fold, seed=3, 30ep)

> 分箱: **全部使用等宽分箱 A** (旧 `pd.cut(bins=4)` bug), bins={310,50,16,4}
> 注意: 新 V51 SlimBridge 使用修复后的等频分箱 B, 不在此列

### V45 (otehv2_rankevent) 多版本

| 版本 | fold0 ep | best | fold1 ep | best | fold2 ep | best | fold3 ep | best | fold4 ep | best | 备注 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| **主跑 (main)** | 1 | 0.7124 | 1 | 0.7191 | **16** | **0.7282** | 14 | 0.6787 | 21 | 0.7140 | 标准 8-loss |
| seed5 | 10 | 0.7338 | 3 | 0.7107 | **12** | **0.7398** | 8 | 0.6546 | 7 | 0.7402 | fold2 历史最高 |
| v45_base | 16 | 0.6854 | 5 | 0.7039 | 6 | 0.6934 | 3 | 0.6372 | 11 | 0.7384 | |
| v45_best | 2 | 0.6941 | 4 | 0.7073 | 11 | 0.7082 | 7 | 0.6481 | 16 | 0.7340 | |
| v45_repro | 1 | 0.6878 | 4 | 0.7132 | 13 | 0.7082 | 5 | 0.6623 | 18 | 0.7166 | |
| seed=3 (alt) | 1 | 0.6926 | 4 | 0.7090 | 23 | 0.7102 | 4 | 0.6426 | 18 | 0.7411 | |
| seed=3 (alt2) | 3 | 0.7044 | 14 | 0.7149 | 13 | 0.6605 | 21 | 0.6874 | 2 | 0.5703 | |

### V45 消融 (otehv2_*)

| 方法 | fold0 ep | best | fold1 ep | best | fold2 ep | best | fold3 ep | best | fold4 ep | best |
|---|---|---|---|---|---|---|---|---|---|---|
| otehv2_rankevent (基准) | 1 | 0.7124 | 1 | 0.7191 | 16 | 0.7282 | 14 | 0.6787 | 21 | 0.7140 |
| otehv2_rankcox | 2 | 0.7139 | 2 | 0.7208 | 12 | 0.7202 | 14 | 0.6585 | 8 | 0.7117 |
| otehv2_capacity | 13 | 0.7258 | 4 | 0.7335 | 15 | 0.7090 | 27 | 0.6787 | 6 | 0.6904 |
| otehv2_crosst | 4 | 0.7060 | 4 | 0.6929 | 10 | 0.7126 | 13 | 0.6874 | 13 | 0.7180 |
| otehv2_epsanneal | 2 | 0.7179 | 3 | 0.7208 | 18 | 0.7114 | 13 | 0.6645 | 8 | 0.6984 |
| otehv2_eta1e5 | 2 | 0.7009 | 2 | 0.7250 | 15 | 0.7062 | 7 | 0.6601 | 8 | 0.7371 |
| otehv2_eventloss | 2 | 0.7187 | 3 | 0.7183 | 18 | 0.7114 | 13 | 0.6372 | 8 | 0.7028 |
| otehv2_globalres | 1 | 0.7163 | 3 | 0.7208 | 18 | 0.7082 | 14 | 0.6393 | 8 | 0.6886 |
| otehv2_norecon | 5 | 0.7100 | 13 | 0.7191 | 14 | 0.6333 | 15 | 0.6831 | 22 | 0.7011 |
| otehv2_hybrid | 25 | 0.7282 | 2 | 0.6844 | 2 | 0.6229 | 18 | 0.6437 | 18 | 0.7180 |
| otehv2_anneal | 2 | 0.7013 | 2 | 0.7246 | 18 | 0.6757 | 8 | 0.6820 | 21 | 0.7198 |
| otehv2_boost | 8 | 0.6862 | 6 | 0.6980 | 9 | 0.6922 | 8 | 0.6224 | 7 | 0.6815 |
| otehv2_strongot | 2 | 0.7013 | 2 | 0.7246 | 11 | 0.7122 | 7 | 0.6656 | 8 | 0.7353 |
| otehv2_strongreg | 2 | 0.7013 | 2 | 0.7276 | 15 | 0.7002 | 13 | 0.6481 | 14 | 0.7193 |
| otehv2_lrhalf | 2 | 0.7036 | 4 | 0.7547 | 9 | 0.6805 | 16 | 0.6951 | 9 | 0.7037 |

### 其他 SlotSPE 方法 (fold2 ≥ 0.70 高亮)

| 方法 | fold0 ep | best | fold1 ep | best | fold2 ep | best | fold3 ep | best | fold4 ep | best |
|---|---|---|---|---|---|---|---|---|---|---|
| **contrastive_v2** | 4 | 0.6759 | 2 | 0.7107 | **22** | **0.7486** | 7 | 0.7016 | 3 | 0.7011 |
| **surgfix** | 1 | 0.7171 | 1 | 0.7073 | **14** | **0.7126** | 9 | 0.7257 | 10 | 0.7153 |
| ot_v3 | 1 | 0.7353 | 1 | 0.7242 | 25 | 0.6869 | 8 | 0.7421 | 24 | 0.7527 |
| ot_v2 | 1 | 0.7353 | 1 | 0.7090 | 1 | 0.6950 | 28 | 0.7191 | 23 | 0.7295 |
| ccmi_v4 | 1 | 0.7005 | 0 | 0.7124 | 19 | 0.6837 | 14 | 0.7027 | 2 | 0.6913 |
| causal_survival | 0 | 0.5000 | 10 | 0.7022 | 22 | 0.7062 | 12 | 0.6514 | 21 | 0.7358 |
| ib_v4 | 26 | 0.7441 | 9 | 0.6895 | 5 | 0.6902 | 5 | 0.6557 | 2 | 0.6708 |
| pathway_event_memory_v2 | 17 | 0.7203 | 25 | 0.7530 | 4 | 0.5821 | 22 | 0.6678 | 5 | 0.7198 |
| ot_event_hazard_v2 | 8 | 0.6910 | 6 | 0.7217 | 25 | 0.6661 | 3 | 0.6699 | 5 | 0.6948 |
| care_region_ot | 3 | 0.7330 | 1 | 0.7107 | 4 | 0.6805 | 13 | 0.6820 | 2 | 0.6922 |
| care_region_ot_pooltemp | 21 | 0.6704 | 1 | 0.7056 | 13 | 0.7150 | 7 | 0.6732 | 1 | 0.6806 |
| baseline | 0 | 0.7235 | 1 | 0.7234 | 4 | 0.6325 | 2 | 0.6842 | 27 | 0.7438 |

> **注意**: 所有 SlotSPE 结果使用旧等宽分箱，c-index 系统性偏高 ~0.05-0.07
> **contrastive_v2 fold2=0.7486 是旧分箱下的 fold2 最高值**，修正后预计 ~0.68-0.70
> **otehv2_rankevent seed5 fold2=0.7398** 也是等宽分箱
