...
## newSlotSPE / SlotSPE 全部方法 5-fold 详细 (seed=3, 30ep, 等宽分箱A)

> 分箱: **等宽分箱 A** (`pd.cut(bins=4)`, bins={310,50,16,4}), c-index 虚高 ~0.05
> 格式: `best(epoch)/last5` — best=该折峰值, last5=最后5 epoch均值(诚实指标)
> V51 例外: 等频分箱 B

### V45 (otehv2_rankevent) 多版本

| 版本 | f0 best(ep)/last5 | f1 best(ep)/last5 | f2 best(ep)/last5 | f3 best(ep)/last5 | f4 best(ep)/last5 | **avg last5** |
|---|---|---|---|---|---|---|
| **seed5** | 0.7338(10)/0.6830 | 0.7107(3)/0.6075 | **0.7398(12)/0.7045** | 0.6546(8)/0.5800 | 0.7402(7)/0.7284 | **0.6607** |
| v45_base | 0.6854(16)/0.6548 | 0.7039(5)/0.6019 | 0.6934(6)/0.6600 | 0.6372(3)/0.6191 | 0.7384(11)/0.7141 | **0.6500** |
| v45_repro | 0.6878(1)/0.6617 | 0.7132(4)/0.5648 | 0.7082(13)/0.6831 | 0.6623(5)/0.6238 | 0.7166(18)/0.7092 | **0.6485** |
| **主跑** | 0.7124(1)/0.6149 | 0.7191(1)/0.5794 | **0.7282(16)/0.7127** | 0.6787(14)/0.6044 | 0.7140(21)/0.7076 | **0.6438** |
| v45_best | 0.6941(2)/0.6772 | 0.7073(4)/0.5845 | 0.7082(11)/0.6861 | 0.6481(7)/0.5979 | 0.7340(16)/0.6406 | **0.6373** |
| alt | 0.6926(1)/0.6300 | 0.7090(4)/0.5860 | 0.7102(23)/0.6986 | 0.6426(4)/0.5196 | 0.7411(18)/0.7279 | **0.6324** |

> seed5 fold2=0.7398(12)/0.7045 — best ep12, last5=0.7045 也健康，但 fold3 拖后腿(0.5800)
> 主跑 fold2=0.7282(16)/0.7127 — peak=0.7282, last5=0.7127 **peak bias 仅 0.0155** → fold2 在这个binning下是真实好，不是peak picking

### V45 消融 5-fold (按 avg last5 降序)

| 方法 | f0 best(ep)/last5 | f1 best(ep)/last5 | f2 best(ep)/last5 | f3 best(ep)/last5 | f4 best(ep)/last5 | **avg last5** |
|---|---|---|---|---|---|---|
| **capacity** | 0.7258(13)/0.7199 | 0.7335(4)/0.6595 | 0.7090(15)/0.6745 | 0.6787(27)/0.6760 | 0.6904(6)/0.6180 | **0.6696** |
| epsanneal | 0.7179(2)/0.6714 | 0.7208(3)/0.5810 | 0.7114(18)/0.7013 | 0.6645(13)/0.6452 | 0.6984(8)/0.6858 | **0.6569** |
| strongreg | 0.7013(2)/0.6614 | 0.7276(2)/0.6175 | 0.7002(15)/0.6729 | 0.6481(13)/0.6303 | 0.7193(14)/0.6791 | **0.6522** |
| crosst | 0.7060(4)/0.6338 | 0.6929(4)/0.5450 | 0.7126(10)/0.7015 | 0.6874(13)/0.6672 | 0.7180(13)/0.7109 | **0.6517** |
| eventloss | 0.7187(2)/0.6647 | 0.7183(3)/0.5821 | 0.7114(18)/0.6988 | 0.6372(13)/0.6111 | 0.7028(8)/0.6924 | **0.6498** |
| globalres | 0.7163(1)/0.6624 | 0.7208(3)/0.5846 | 0.7082(18)/0.6878 | 0.6393(14)/0.6306 | 0.6886(8)/0.6813 | **0.6493** |
| eta1e5 | 0.7009(2)/0.6593 | 0.7250(2)/0.6039 | 0.7062(15)/0.6893 | 0.6601(7)/0.6326 | 0.7371(8)/0.6604 | **0.6491** |
| strongot | 0.7013(2)/0.6605 | 0.7246(2)/0.6012 | 0.7122(11)/0.6844 | 0.6656(7)/0.6261 | 0.7353(8)/0.6649 | **0.6474** |
| norecon | 0.7100(5)/0.6222 | 0.7191(13)/0.6548 | 0.6333(14)/0.5641 | 0.6831(15)/0.6494 | 0.7011(22)/0.6443 | **0.6270** |
| anneal | 0.7013(2)/0.6605 | 0.7246(2)/0.6012 | 0.6757(18)/0.6564 | 0.6820(8)/0.5735 | 0.7198(21)/0.6189 | **0.6221** |
| rankcox | 0.7139(2)/0.5928 | 0.7208(2)/0.5465 | 0.7202(12)/0.6938 | 0.6585(14)/0.5447 | 0.7117(8)/0.6783 | **0.6112** |
| hybrid | 0.7282(25)/0.6324 | 0.6844(2)/0.5433 | 0.6229(2)/0.5905 | 0.6437(18)/0.5871 | 0.7180(18)/0.5947 | **0.5896** |
| lrhalf | 0.7036(2)/0.5623 | 0.7547(4)/0.4071 | 0.6805(9)/0.6570 | 0.6951(16)/0.5013 | 0.7037(9)/0.7019 | **0.5659** |
| **基准** | 0.7124(1)/0.6149 | 0.7191(1)/0.5794 | 0.7282(16)/0.7127 | 0.6787(14)/0.6044 | 0.7140(21)/0.7076 | **0.6438** |

> capacity 最优但 fold4 last5=0.6180 弱; 基准 fold1 last5=0.5794 也弱
> 关键模式: **fold0/fold1→弱 last5, fold2→强 last5** (等宽分箱的分布效应)

### 其他 SlotSPE 方法 5-fold (top 12)

| 方法 | f0 best(ep)/last5 | f1 best(ep)/last5 | f2 best(ep)/last5 | f3 best(ep)/last5 | f4 best(ep)/last5 | **avg last5** |
|---|---|---|---|---|---|---|
| transport_event_graph | 0.6870(2)/0.6743 | 0.7039(8)/0.6607 | 0.6053(5)/0.5946 | 0.6612(3)/0.5596 | 0.8052(18)/0.7536 | **0.6486** |
| pathway_event_memory | 0.6783(1)/0.5881 | 0.7039(0)/0.5738 | 0.6445(8)/0.6347 | 0.7071(22)/0.7064 | 0.7295(3)/0.6808 | **0.6368** |
| counterfactual_pathway | 0.6815(7)/0.6331 | 0.6937(0)/0.5547 | 0.6669(3)/0.6045 | 0.7071(7)/0.6896 | 0.6966(2)/0.6489 | **0.6262** |
| ot_v2 | 0.7353(1)/0.6160 | 0.7090(1)/0.5856 | 0.6950(1)/0.5566 | 0.7191(28)/0.6739 | 0.7295(23)/0.6984 | **0.6261** |
| surgfix | 0.7171(1)/0.5919 | 0.7073(1)/0.6117 | 0.7126(14)/0.6347 | 0.7257(9)/0.6444 | 0.7153(10)/0.6418 | **0.6249** |
| event_capsule_routing | 0.7100(7)/0.6393 | 0.7403(10)/0.6066 | 0.6245(6)/0.5717 | 0.7060(15)/0.6341 | 0.6913(7)/0.6665 | **0.6236** |
| neural_event_dynamics | 0.7278(9)/0.6864 | 0.7318(15)/0.6785 | 0.6325(24)/0.5294 | 0.6820(15)/0.5646 | 0.6913(23)/0.6528 | **0.6223** |
| **contrastive_v2** | 0.6759(4)/0.6184 | 0.7107(2)/0.5251 | **0.7486(22)/0.7074** | 0.7016(7)/0.6338 | 0.7011(3)/0.6053 | **0.6180** |
| ot_v3 | 0.7353(1)/0.6960 | 0.7242(1)/0.6796 | 0.6869(25)/0.6314 | 0.7421(8)/0.6754 | 0.7527(24)/0.6391 | **0.6643** |
| evidential_v2 | 0.6878(0)/0.6553 | 0.7191(2)/0.6253 | 0.6829(11)/0.5506 | 0.7071(8)/0.6214 | 0.6966(15)/0.5883 | **0.6082** |
| ccmi_v4 | 0.7005(1)/0.5318 | 0.7124(0)/0.5978 | 0.6837(19)/0.6484 | 0.7027(14)/0.6580 | 0.6913(2)/0.5976 | **0.6067** |
| ot_event_hazard | 0.6727(8)/0.6259 | 0.7098(10)/0.6349 | 0.6557(21)/0.5664 | 0.6831(23)/0.5736 | 0.6948(26)/0.6157 | **0.6033** |

### contrastive_v2 深度分析

**代码状态**: ❌ 已删除 — `02_contrastive_slot_register/model_v2.py` 不存在于磁盘

**改动内容** (从 `extended_args.py` + `model_factory.py` 残留参数重建):
- 基于 `SlotSPE` 骨干，新增 register tokens (4 WSI + 4 omic) 做跨模态对比学习
- 损失: survival NLL + decoder 辅助 + reconstruction + diversity(L_div=0.05) + attention(L_attn=0.02) + L_contrast(0.1, warmup=5 ep)

**为什么 fold2=0.7486 这么高但 5-fold avg 只有 0.6180？**

| fold | best(ep)/last5 | 分析 |
|:---:|:---:|---|
| 0 | 0.6759(4)/0.6184 | 早期峰值→迅速衰减 |
| 1 | 0.7107(2)/0.5251 | ep2 峰值, last5 崩到 0.52 → **过拟合后崩塌** |
| 2 | 0.7486(22)/0.7074 | late peak, last5 也高 (peak bias 仅 0.04) |
| 3 | 0.7016(7)/0.6338 | ep7 峰值, last5=0.63 |
| 4 | 0.7011(3)/0.6053 | ep3 峰值, 衰减严重 |

- fold1 的 last5=0.5251 是灾难性的 — contrastive loss warmup 5ep 后模型剧烈震荡
- fold2 是唯一表现好的 fold — 恰好 warmup 后 convergence 对 fold2 有利
- **排名靠后 (8/12)** 因为 5-fold 均值被 fold0/fold1/fold4 拖垮

> **结论**: contrastive_v2 的 fold2=0.7486 是等宽分箱 + late peak (ep22) + fold1 崩塌的特殊组合，不代表模型真实性能。代码已删除，无需恢复。

### V51 SlimBridge (等频分箱 B, 5-fold)

| 版本 | f0 best(ep)/last5 | f1 best(ep)/last5 | f2 best(ep)/last5 | f3 best(ep)/last5 | f4 best(ep)/last5 | **avg last5** |
|---|---|---|---|---|---|---|
| seed3 | 0.7433(5)/0.7118 | 0.7191(4)/0.6552 | 0.5821(16)/0.5560 | 0.6650(11)/0.6157 | 0.6837(11)/0.5645 | **0.6206** |
| seed5 | 0.7385(3)/0.6599 | 0.7014(4)/0.6374 | 0.5689(15)/0.5388 | 0.6459(5)/0.6249 | — | **0.6153** (4f) |

> 等频分箱下 fold2 一致崩溃 (~0.56), 非分箱原因, 是 SlimBridge 架构问题

> **注意**: 所有 SlotSPE 结果用等宽分箱 A, c-index 虚高 ~0.05；V51 用等频分箱 B
> **otehv2_capacity avg_last5=0.6696 (消融最优)**, 比基准 +0.026
> **ot_v3 avg_last5=0.6643 被上次标注"失败"是误判** — 重新提取 5-fold last5 后实际排 second
