...
## Fix 队列 5-fold noseed 结果 (2026-07-14)

> 分箱: **全部使用策略 B** (等频 on 未删失, 全局), bins={69,76,82,153}
> 参数: 5-fold, 30ep, seed=None, 独立 results_dir `_5fold_noseed`

### 批次状态

| # | 方法 | 状态 | 5-fold last5 | 分箱 |
|---|------|:---:|:------------:|:---:|
| 1 | **v45_norank** | ✅ | **0.6406** | B |
| 2 | v45v2_norank | 🔄 fold1 | — | B |
| 3 | v50_norank | ⏳ | — | B |
| 4 | rg_et_fix | ⏳ | — | B |
| 5 | catet_fix | ⏳ | — | B |
| 6 | dct_fix | ⏳ | — | B |
...
> ✅ fold2 从旧 0.6013 → **0.6637** (+0.062), 全局分箱修复确认有效
> peak bias +0.044: fold0 ep2 0.7361 极不稳定，last5 仅 0.6536
> fold3 (0.6273/0.6021) 是 5 折中最难的
...
> fold0 与 v45_norank 一致 (0.7433 @ ep2), clinical 特征未提供提升

### V51 SlimBridge seed3+seed5 (newSlotSPE)

| Fold | seed3 best | seed3 last5 | seed5 best | seed5 last5 |
|:----:|:----------:|:-----------:|:----------:|:-----------:|
| 0 | 0.7433 | 0.7118 | 0.7385 | 0.6599 |
| 1 | 0.7191 | 0.6552 | 0.7014 | 0.6374 |
| 2 | 0.5821 | 0.5560 | 0.5689 | 0.5388 |
| 3 | 0.6650 | 0.6157 | 0.6306 | 🔄 |
| 4 | 0.6837 | 0.5645 | — | — |
| **mean** | 0.6786 | **0.6206** | — | **0.5606** (3 folds) |

> ❌ 两个种子 fold2 一致崩溃 (0.56–0.58), fold4 不稳定 (last5 0.56), SlimBridge 架构不可用
> peak bias 严重: seed3 均值 bias +0.058

### V60 OT Event Rank

⏳ 等待 V51 seed5 完成后自动启动
