...
|---:|---|---|---:|---:|---|---|---|---|
| 1 | **DCT v3.3 score-first** | BLCA `0.7311±0.0293`；BRCA `0.7062±0.0420`；LUAD `0.7100±0.0348`；LUSC `0.6254±0.0364` | 2 | 7.5/10 | 中 | Q3；证据补强后可试 Q2 | Q1/Q2；CCF B 有条件，CCF A 不现实 | 第一主线 |
