...
from model import OTEHV2RankEvent  # noqa: 本文件夹自己的模型，不走 model_factory
...
def init_model(args, dataset_factory):
    ...
    print("[init] 加载模型: OTEHV2RankEvent (V45, 独立版)")
    model = OTEHV2RankEvent(
        args,
...
def run(args):
    args.method = "SlotSPE_otehv2_rankevent"
