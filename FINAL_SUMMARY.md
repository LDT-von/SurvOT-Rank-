...
|:----:|------|:------:|:-----:|:-----:|:-----:|:--------:|:----:|
| 1 | v3.8.2 MGPTR | UNI2-h | 0.7073 | 0.6745 | 0.7658 | **0.7159** | ✅ |
| 2 | v4.0 IST-Surv | UNI2-h | 0.6707 | 0.6767 | 0.7761 | **0.7078** | ✅ |
| 3 | v3.3 Score-First | UNI | 0.7151 | 0.6930 | 0.6729 | **0.7074** | ✅ (复现) |
| 4 | v4.1 Evidence Ledger | UNI | 0.7300 | 0.6354 | 0.7462 | **0.7039** | ✅ |
| 5 | ArcSurv | UNI | 0.6702 | 0.6134 | 0.7436 | **0.6757** | ✅ |
| 6 | v3.9 Risk-Simplex | UNI2-h | 0.6320 | 0.6776 | 0.6085 | **0.6394** | ✅ |
| 7 | v3.8.3 Centered | UNI2-h | 0.5931 | 0.6193 | — | 中止 | ❌ |

> v3.8.2 MGPTR 以 0.7159 排名第一，fold4=0.7658 接近 v4.0 IST-Surv 单折最高 (0.7761)，且三折方差较小。
> v3.3 复现均值 0.7074 (fold1-4)，与早前 (0.7311) 略有差异因 folds 不同。
> v3.8.3 Centered fold1=0.5931, fold2 best=0.6193 (未完成)，远低于基线，已中止。

### 跨方法 fold 分析

| Fold | v3.8.2 | v3.3 | v4.1 | v4.0 | ArcSurv | v3.9 | v3.8.3 |
|:----:|:------:|:----:|:----:|:----:|:-------:|:----:|:------:|
| 1 | 0.7073 | 0.6930 | 0.7300 | 0.6707 | 0.6702 | 0.6320 | 0.5931 |
| 2 | 0.6745 | 0.6729 | 0.6354 | 0.6767 | 0.6134 | 0.6776 | 0.6193 |
| 4 | 0.7658 | 0.7222 | 0.7462 | 0.7761 | 0.7436 | 0.6085 | — |
