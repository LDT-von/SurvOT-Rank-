...
| 日期 | 问题 | 详情 | 状态 |
|:----:|------|------|:----:|
| 07-30 | v3.8 调度器重复fork | 5个LUAD fold0训练进程同时写入同一 results_dir (PID 1051798, 1073475~1073478)，可能导致结果错乱 | 🔴 待处理 |
| 07-29 | v3.7 LUSC fold0=0.4575 | C-Index 异常偏低，可能数据或配置有问题 | ⚠️ 待排查 |
