...
| 5 | 补齐 fold0/fold3 到五折 | ✅ **已完成（DCT 6癌种）** | — | DCT v3.8.2 6 癌种各五折全部完成。IST 进行中（2/6 癌种完成） |
...
**结算：20 项中已完成 13（#1 #2 #4 #5 #7 #8 #9 #10 #11 #12 #15 #17 #18）、修复无效 2（#19 #20）、部分完成 4（#6 #13 #14 #16）、未开始 1（#3）。**

> #4 已被 #17 取代（旧形式测不到自适应权重）。#14 已确认：clean 基线实际为 0.7120（非 0.7400），旧 leaky 基线 0.6958 已废除。

### 当前优先级（2026-08-06，跨癌种 DCT 完成，IST 进行中）

| 序 | 方法 | 状态 | 下一步 |
|:-:|------|------|--------|
| 1 | **DCT v3.8.2 fixed** | ✅ DCT 6癌种五折全部完成。最高 UCEC 0.8224。 | 等待 IST 完成后写入论文 |
| 2 | **IST v4.0 abl_b** | 🔄 跨癌种进行中（2/6 完成）。BLCA/SKCM 均未超过 DCT。 | 等全部完成 |
...
### IST v4.0 abl_b 跨癌种五折结果 (进行中, 2026-08-06, UNI2-h, 50ep)

| 癌种 | F0 | F1 | F2 | F3 | F4 | **Mean** | 状态 |
|:---:|:---:|:---:|:---:|:---:|:---:|:---:|:--:|
...
> BLCA IST (0.6843) 低于 DCT (0.7107) 差 0.0264，SKCM IST (0.6653) 与 DCT (0.6608) 基本持平。
> **趋势：IST v4.0 abl_b 在已完成的两个癌种上未超过 DCT v3.8.2。**
